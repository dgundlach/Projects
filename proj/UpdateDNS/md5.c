...
/* $Id: md5.c,v 1.2 1996/12/12 00:04:48 baskar Exp $ */
...
static void MD5Transform P__ ((UINT4 [4], unsigned char [64]));
static void Encode P__
  ((unsigned char *, UINT4 *, unsigned int));
static void Decode P__
  ((UINT4 *, unsigned char *, unsigned int));
static void MD5_memcpy P__ ((POINTER, POINTER, unsigned int));
static void MD5_memset P__ ((POINTER, int, unsigned int));

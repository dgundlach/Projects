...
create or replace function crypt(varchar) returns varchar as SQUOTE
...
SQUOTE language 'plperl';

create or replace function change_user() returns trigger as SQUOTE
declare
    query      text;
    sep        text;
    crypted    varchar;
